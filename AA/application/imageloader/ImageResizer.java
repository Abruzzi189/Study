...
public class ImageResizer extends ImageWorker {
    ...
    if (cache != null) {
      ...
      if (inBitmap != null) {
        if (BuildConfig.DEBUG) {
          LogUtils.d(TAG, "Found bitmap to use for inBitmap");
        }
   ...
   */
  private Bitmap processBitmap(int resId, int width, int height) {
    if (BuildConfig.DEBUG) {
      LogUtils.d(TAG, "processBitmap - " + resId);
    }
    return decodeSampledBitmapFromResource(mResources, resId, width,

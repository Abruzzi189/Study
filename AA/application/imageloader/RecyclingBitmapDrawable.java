 ...
 * is no longer being displayed or cached, {@link Bitmap#recycle() recycle()} will be called on this
 * drawable's bitmap.
 */
public class RecyclingBitmapDrawable extends BitmapDrawable {
   ...
   * the drawable knows when it is no longer being displayed.
   *
   ...
   * drawable knows when it is no longer being cached.
   *

...
public abstract class ImageLoader {
  ...
  public static boolean cancelPotentialWork(Object data, ImageView imageView) {
    ...
    if (bitmapWorkerTask != null) {
      ...
      if (bitmapData == null || !bitmapData.equals(data)) {
        bitmapWorkerTask.cancel(true);
        if (BuildConfig.DEBUG) {
          LogUtils.d(TAG, "cancelPotentialWork - cancelled work for " + data);
        }
      } else {
   ...
   * ImageLoader#processBitmap(Object)} to define the processing logic). If the image is found in
   * the memory cache, it is set immediately, otherwise an {@link AsyncTask} will be created to
   ...
   * ImageLoader#loadImage(Object, ImageView)}
